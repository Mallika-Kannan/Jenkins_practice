nano ./my-java-app/templates/_helpers.tpl
# or use your favorite editor like VS Code
# code ./my-java-app/templates/_helpers.tpl
...
{{- default (include "my-java-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
